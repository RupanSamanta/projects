...
function drawCard()
{
	  ...
	  img.src = cards;
		    ...
		    cnt.onload = function ()
		    {
		    			ctx.drawImage(cnt,554,356,142, 142/ratio(cnt.width, cnt.height, 'w')*ratio(cnt.width, cnt.height, 'h')); console.log(142/ratio(cnt.width, cnt.height, 'w')*ratio(cnt.width, cnt.height, 'h'));
		    }
		    ctx.textAlign = 'center';
		    ctx.font = '66px Reno';
		    ctx.fillStyle = black;
